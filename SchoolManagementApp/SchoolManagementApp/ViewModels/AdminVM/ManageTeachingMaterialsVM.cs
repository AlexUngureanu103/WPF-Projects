...
{
    public class ManageTeachingMaterialsVM : BaseVM
    {
        ...
        public ManageTeachingMaterialsVM( ICourseService courseService, ICourseClassTeacherService courseClassTeacherService, ITeachingMaterialsService teachingMaterialsService)
        {
            ...
            TeachingClassesList = _courseClassTeacherService.GetAll();
